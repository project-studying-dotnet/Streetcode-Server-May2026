...
namespace Streetcode.XUnitTest.BLL.MediatR.Media.ArtSlide.Create
{
    public class CreateArtSlideHandlerTests
    {
        ...
        public async Task Handle_ShouldReturnFail_WhenStreetcodeDoesNotExist()
        {
            ...
            string expectedMessage = ErrorMessages.StreetcodeNotFound ?? "Streetcode with id {0} not found.";
            result.Errors.Should().ContainSingle(e => e.Message.Contains(string.Format(expectedMessage, requestDto.StreetcodeId)));
        }
