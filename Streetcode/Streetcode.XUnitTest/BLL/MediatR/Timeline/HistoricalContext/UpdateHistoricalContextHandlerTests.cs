...
public sealed class UpdateHistoricalContextHandlerTests
{
    ...
    private UpdateHistoricalContextHandler Handler { get; }
    ...
    public UpdateHistoricalContextHandlerTests()
    {
        ...
        Handler = new UpdateHistoricalContextHandler(RepositoryWrapperMock.Object, Mapper, LoggerMock.Object);
    }
    ...
    public async Task Handle_ReturnsUpdatedHistoricalContext_WhenUpdatedSuccessfully()
    {
        ...
        HistoricalContextRepositoryMock.Setup(r => r.Update(context));
        ...
        HistoricalContextRepositoryMock.Verify(r => r.Update(context), Times.Once);
