...
namespace Streetcode.XUnitTest.BLL.MediatR.Partners.GetAllPartnerShort
{
    public class GetAllPartnerShortPartnersHandlerTests
    {
        ...
        public GetAllPartnerShortPartnersHandlerTests()
        {
            ...
            {
                cfg.CreateMap<Partner, PartnerShortDTO>();
            }).CreateMapper();
            ...
            _handler = new GetAllPartnerShortHandler(_mockRepo.Object, _mapper, _mockLogger.Object);
        }
        ...
        public async Task Handle_ShouldReturnPartners_WhenPositionsExist()
        {
            ...
            result.Value.Should().BeEquivalentTo(_mapper.Map<IEnumerable<PartnerShortDTO>>(partners));
        }
