...
namespace Streetcode.WebApi.InitialData.PersonStreetcodeSeeder
{
    ...
    public static class PersonStreetcodeSeeder
    {
       ...
       var entities = new List<PersonStreetcode>
        {
            ...
            "Академік Імператорської академії мистецтв",
                ...
                EventStartOrPersonBirthDate = DateTime.SpecifyKind(new DateTime(1814, 3, 9), DateTimeKind.Utc),
                EventEndOrPersonDeathDate = DateTime.SpecifyKind(new DateTime(1861, 3, 10), DateTimeKind.Utc),FirstName = "Тарас",
                Rank = "Григорович",
                LastName = "Шевченко",
            ...
            new ()
            {
                ...
                EventStartOrPersonBirthDate = DateTime.SpecifyKind(new DateTime(1997, 7, 5), DateTimeKind.Utc),
                EventEndOrPersonDeathDate = DateTime.SpecifyKind(new DateTime(2022, 6, 9), DateTimeKind.Utc),FirstName = "Роман",
                LastName = "Ратушний",
       ...
       await context.Streetcodes.SeedIfEmptyAsync(
            entities,
            context);
        }
    }
