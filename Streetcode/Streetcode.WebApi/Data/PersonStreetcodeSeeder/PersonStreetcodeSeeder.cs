        ...
        public static async Task FillSeedAsync(StreetcodeDbContext context)
        {
            var entities = new List<PersonStreetcode>
            {
                new()
                {
                    ...
                    EventEndOrPersonDeathDate = DateTime.SpecifyKind(new DateTime(1861, 3, 10), DateTimeKind.Utc),
                    FirstName = "Тарас",
                    Rank = "Григорович",
                    LastName = "Шевченко",
                ...
                new()
                {
                    ...
                    EventEndOrPersonDeathDate = DateTime.SpecifyKind(new DateTime(2022, 6, 9), DateTimeKind.Utc),
                    FirstName = "Роман",
                    LastName = "Ратушний",
